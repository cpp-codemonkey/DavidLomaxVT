<?php
	...
	*/
	...
	$email_to = "classicalvingtsun108@gmail.com"; 	// Specify the email address you want to send the mail to.
	$email_from = "mailbox@classicalvingtsunwatford.co.uk";  //Specify the email address that you want to send the email from. This needs to be Fasthosts hosted,
	$email_subject = "New Submission from David Lomax VKVT"; 	// Set the subject of your email.
	// Specify a page on your website to display a thankyou message when the mail is sent
	$thankyou_url = "http://www.classicalvingtsunwatford.co.uk/thankyou.html";
